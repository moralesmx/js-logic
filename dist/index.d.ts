...
declare type Rule$Every = ['$every', RuleOrValue, RuleOrValue];
declare type Rule$Some = ['$some', RuleOrValue, RuleOrValue];
declare type Rule$Reduce = ['$reduce', RuleOrValue, RuleOrValue, RuleOrValue];
declare type Rule$Typeof = ['$typeof', RuleOrValue, RuleOrValue];
declare type Rule$In = ['$in', RuleOrValue, RuleOrValue];
declare type Rule$Method = ['$method', RuleOrValue, RuleOrValue, ...RuleOrValue[]];
declare type Rule = Rule$ | Rule$$ | Rule$And | Rule$Or | Rule$Equal | Rule$StrictEqual | Rule$NotEqual | Rule$StrictNotEqual | Rule$Not | Rule$DoubleNot | Rule$GraterThan | Rule$GraterThanOrEqual | Rule$LessThan | Rule$LessThanOrEqual | Rule$Addition | Rule$Multiplication | Rule$Subtraction | Rule$Division | Rule$Modulo | Rule$Exponentiation | Rule$Map | Rule$Filter | Rule$Every | Rule$Some | Rule$Reduce | Rule$Typeof | Rule$In | Rule$Method;
